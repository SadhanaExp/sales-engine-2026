 ...
 *
 * Page and API guards also live in their handlers. This proxy keeps Ready to
 * Contract closed by default before route code runs.
 *
...
const CONTRACT_PREFIXES = ["/api/contract", "/api/handoff"];
